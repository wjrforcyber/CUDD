/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: ntr.h,v 1.21 2001/04/03 23:58:31 fabio Exp fabio $]
...
EXTERN int Ntr_TestEquivAndContain ARGS((DdManager *dd, BnetNetwork *net1, BnetNetwork *net2, NtrOptions *option));
EXTERN int Ntr_TestClosestCube ARGS((DdManager * dd, BnetNetwork * net, NtrOptions * option));
...
EXTERN int Ntr_ShortestPaths ARGS((DdManager *dd, BnetNetwork *net, NtrOptions *option));
