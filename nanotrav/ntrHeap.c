...
#ifndef lint
static char rcsid[] UTIL_UNUSED = "$Id: ntrHeap.c,v 1.2 2001/02/15 07:07:46 fabio Exp fabio $";
#endif
...
static void ntrHeapify ARGS((NtrHeap *heap, int i));
static int ntrHeapResize ARGS((NtrHeap *heap));
