...
#ifndef lint
static char rcsid[] UTIL_UNUSED = "$Id: ntrShort.c,v 1.2 1999/09/07 18:56:58 fabio Exp fabio $";
#endif
...
static DdNode * ntrBellman ARGS((DdManager *dd, DdNode *D, DdNode *source, DdNode **x, DdNode **y, int vars, int pr));
static DdNode * ntrWarshall ARGS((DdManager *dd, DdNode *D, DdNode **x, DdNode **y, int vars, int pr));
static DdNode * ntrSquare ARGS((DdManager *dd, DdNode *D, DdNode **x, DdNode **y, DdNode **z, int vars, int pr, int st));
